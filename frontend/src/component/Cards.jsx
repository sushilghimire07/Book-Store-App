...
function Cards({ item }) {
  return (
    <div className="mt-10 mb-10 px-4 flex justify-center">
      <div
        className="w-full max-w-xs bg-white dark:bg-gray-800 text-gray-900 dark:text-white
      ...
      >
        ...
        <div className="p-4 flex flex-col justify-between h-full">
          <div>
            ...
            <div>
              <button
                className="px-3  mt-2 mb-1 py-1 text-sm font-semibold rounded-full border-2

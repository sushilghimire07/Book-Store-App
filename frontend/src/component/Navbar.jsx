...
const Navbar = () => {
  ...
  return (
    <div className={`navbar bg-base-100 shadow-sm fixed top-0 left-0 right-0 z-50 ${sticky ? 'shadow-md bg-base-250 duration-300 transition-all ease-in-out' : ''}`}>
      <div className="navbar-start">
        ...
        <a href="/" className="text-2xl font-bold cursor-pointer ml-2">o|o</a>
      </div>
